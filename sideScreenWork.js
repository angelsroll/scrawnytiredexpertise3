document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('startSideAnimation', (event) => {
        ...
        const totalDistance = initialVelocityX * (duration / 1000) + sideInitialRadius; //distance ball travels
        ...
        createjs.Tween.get(sideBall)
            .to({ y: sideCanvas.height - sideInitialRadius - peakHeight }, duration / 2, createjs.Ease.getPowOut(2))//might be good actually
